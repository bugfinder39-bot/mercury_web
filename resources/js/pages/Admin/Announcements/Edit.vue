...
const form = useForm({
    ...
    short_description: props.announcement.short_description || '',
    full_description: props.announcement.full_description || '',
    type: props.announcement.type || 'General',
    priority: props.announcement.priority || 'Normal',
    bg_color: props.announcement.bg_color || '#0284c7',
    text_color: props.announcement.text_color || '#ffffff',
    icon: props.announcement.icon || 'Megaphone',
    button_text: props.announcement.button_text || '',
    button_url: props.announcement.button_url || '',
    display_order: props.announcement.display_order ?? 0,
    is_active: Boolean(props.announcement.is_active),
    is_pinned: Boolean(props.announcement.is_pinned),
    is_dismissible: Boolean(props.announcement.is_dismissible),
    start_date: formatDateForInput(props.announcement.start_date),
    end_date: formatDateForInput(props.announcement.end_date),
    display_location: props.announcement.display_location || 'top_bar',
    target_pages: props.announcement.target_pages || 'all',
    specific_pages: Array.isArray(props.announcement.specific_pages)
        ? [...props.announcement.specific_pages]
        : [],
});
        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Modify announcement content, appearance, and target rules.</p>
                </div>
            </div>
        </div>
