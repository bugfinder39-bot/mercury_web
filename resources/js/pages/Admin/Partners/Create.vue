...
const submit = () => {
    // When sending files via post/put, Inertia handles the Multipart conversion automatically
    ...
    <div class="space-y-6 max-w-3xl">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <h1 class="text-3xl font-bold font-display text-base-content mt-0.5" style="color: #0B2540;">Create Partner</h1>
            </div>
        </div>
        ...
        <div class="card-premium border border-slate-200 p-6 md:p-8">
            <form @submit.prevent="submit" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div class="space-y-1">
                                ...
                                <p class="text-[11px] text-slate-400 font-body block">
                                    Supported types: JPEG, PNG, JPG, GIF, SVG, WEBP. Max size: 2MB.
                                </p>
                ...
                <div class="flex justify-end gap-3 pt-5 border-t border-slate-200">
                    ...
                    >
                        <Save class="size-4" />
                        <span>{{ form.processing ? 'Saving...' : 'Create Partner' }}</span>
                    </button>
                </div>
