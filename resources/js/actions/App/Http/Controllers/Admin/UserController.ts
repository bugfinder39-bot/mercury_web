 ...
 * @see app/Http/Controllers/Admin/UserController.php:268
 ...
 * @see app/Http/Controllers/Admin/UserController.php:289
 * @route '/admin/users/{user}'
 */
...
const UserController = { toggleStatus, resetPassword, index, create, store, show, edit, update, destroy }
