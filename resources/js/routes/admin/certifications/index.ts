...
/**
* @see \App\Http\Controllers\Admin\CertificationController::sectionSettings
 * @see app/Http/Controllers/Admin/CertificationController.php:273
 * @route '/admin/certifications/section-settings'
 */
export const sectionSettings = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: sectionSettings.url(options),
    method: 'put',
})

sectionSettings.definition = {
    methods: ["put"],
 ...
 * @route '/admin/certifications/section-settings'
 */
sectionSettings.url = (options?: RouteQueryOptions) => {
    return sectionSettings.definition.url + queryParams(options)
}
 ...
 * @route '/admin/certifications/section-settings'
 */
sectionSettings.put = (options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: sectionSettings.url(options),
    method: 'put',
})
 ...
 * @route '/admin/certifications/section-settings'
 */
    const sectionSettingsForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: sectionSettings.url({
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/admin/certifications/section-settings'
 */
        sectionSettingsForm.put = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: sectionSettings.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    sectionSettings.form = sectionSettingsForm
/**
...
sectionSettings: Object.assign(sectionSettings, sectionSettings),
